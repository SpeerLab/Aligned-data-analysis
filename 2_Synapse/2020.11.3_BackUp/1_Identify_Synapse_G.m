...
clc
%
base_path = 'Z:\Chenghang\10.30.2020_test\';
...
%
    ...
    imwrite(Result(:,:,1),[outpath 'Gconv_filter_' sprintf('%03d',1) '.tif']);
...
%
% parfor i = 1:num_images
imwrite(uint8(CG(:,:,1)),[outpath 'Storm_Thre_G' sprintf('%03d',1) '.tif']);
% end
%%
%
%clear bg2
