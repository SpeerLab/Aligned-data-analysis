...
clear all;clc
%
base_path = 'X:\Chenghang\OPN4_SCN\2021.4.25_P8Het_A\'; 
...
%
save([outpath 'add_to_statsVw10_edges_in.mat'],'centG_p140','tintsG_p140',...)
    'volumeG_p140','statxture_all','statxture_pos','-v7.3')
save([outpath 'statsV2w10_edges_plus_in.mat'],'statsGwater','-v7.3')