...
clear all;clc
%
base_path = 'X:\Chenghang\4_Color\Raw\1.12.2021_P8EC_A\';
...
%
load([outpath 'V_paired_C_out.mat']);
...
temp = temp';
save([save_path 'statsVwater_sss.Area_out.txt'],'temp','-ascii','-double');
temp = [statsVwater_ss.TintsG];
temp = temp';
save([save_path 'statsVwater_sss.TintsG_out.txt'],'temp','-ascii','-double');
temp = [statsVwater_sn.Area];
temp = temp';
save([save_path 'statsVwater_ssn.Area_out.txt'],'temp','-ascii','-double');
temp = [statsVwater_sn.TintsG];
temp = temp';
save([save_path 'statsVwater_ssn.TintsG_out.txt'],'temp','-ascii','-double');