...
%
save([outpath 'G_add_to_statsVCw10_edges_in.mat'],'centG_p140','tintsG_p140',...)
    'volumeG_p140','statxture_all','statxture_pos','-v7.3')
save([outpath 'statsG2w10_edges_plus_VC_in.mat'],'statsGwater','-v7.3')