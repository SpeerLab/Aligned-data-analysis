...
statsGwater = statsRwater_ssss_out;
%
...
%
save([outpath 'R_add_to_statsVCw10_edges_out.mat'],'centG_p140','tintsG_p140',...)
    'volumeG_p140','statxture_all','statxture_pos','-v7.3')
save([outpath 'statsR2w10_edges_plus_VC_out.mat'],'statsGwater','-v7.3')