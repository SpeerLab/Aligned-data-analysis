...
V_path = [exp_folder '\Result\3_Vglut2\'];
%
load([outpath 'statsC2sw10.mat']);
statsRwater = statsGa2s;
clear statsGwater
%
%Changed 3.4.2021
clear statsGa2s statsGwater
load([outpath 'split_cluster.mat']);
statsGwater = statsVwater_ss_out;
%
...
%
save([outpath 'add_to_statsVw10_edges_out.mat'],'centG_p140','tintsG_p140',...)
    'volumeG_p140','statxture_all','statxture_pos','-v7.3')
save([outpath 'statsV2w10_edges_plus_out.mat'],'statsGwater','-v7.3')