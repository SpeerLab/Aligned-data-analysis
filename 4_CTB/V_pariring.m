clear;clc
%
base_folder = 'Y:\Chenghang\04_4_Color\Control_Group\chenghaz_013_XB2_P4_Control_B\analysis\Result\4_CTB\';
outpath = base_folder;
...
Eps = 0.102; clustID = 1; classg = zeros(numel(RDg),1);
for i = 1:numel(RDg)
    if RDg(orderg(i))>Eps
        if CDg(orderg(i))<=Eps
