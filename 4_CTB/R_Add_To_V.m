...
load([V_syn_path 'R_paired_3.mat']);
...
%
save([outpath 'R_add_to_statsVCw10_edges.mat'],'centG_p140','tintsG_p140',...)
    'volumeG_p140','statxture_all','statxture_pos','-v7.3')
save([outpath 'statsR2w10_edges_plus_VC.mat'],'statsGwater','-v7.3')