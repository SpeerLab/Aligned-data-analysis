...
%
load([outpath 'G_paired_C.mat']);
statsRwater = statsGwater_Cs;
clear statsGwater
%
clear statsGa2s statsGwater
load([Syn_path 'R_paired_2.mat']);
statsGwater = statsRwater_sss;
%
...
save([outpath 'R_add_to_statsGCw10_edges.mat'],'centG_p140','tintsG_p140',...)
    'volumeG_p140','statxture_all','statxture_pos','-v7.3')
save([outpath 'statsR2w10_edges_plus_GC.mat'],'statsGwater','-v7.3')