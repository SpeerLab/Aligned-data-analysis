...
clear all;clc
%%
%In this file the selected Vglut2 clusters will be paired with Bassoon (statsRwater)
...
%set the output path for the Vglut2 values. 
%outpath_syn is the path of my paired synapses. They contain
%statsGwater_sss and statsRwater_sss. So before processing Vglut2 signals,
%I need to process the synapses and find the paired pre- and post-
%clusters. 
...
%'V' for Vglut2. So from here Vglut2 clusters will be called statsVwater
%rather than statsGwater...
load([outpath 'statsV2sw10.mat']);
statsVwater = statsGa2s;

%Add_to similar to synapse process. Only shell size of 140 is used. 
clear BP BG bg2
