...
clc
%%
%Again, using the Bassoon clusters paired with Vglut2 to find their partner Homer1(green)
%clusters. 
...
%
%The name here might be confusing... Because I always use statsVwater to
%search for nearby statsRwater... In the end only tintsG_p140 is useful,
%who are acutally tintsR_p140. 
load([Syn_path 'G_paired_2.mat']);
statsRwater = statsGwater_sss;
clear statsGwater
%
...
%
save([outpath 'add_to_statsGw10_edges_Vglut2.mat'],'centG_p140','tintsG_p140',...)
    'volumeG_p140','statxture_all','statxture_pos','-v7.3')
save([outpath 'statsG2w10_edges_plus_Vglut2.mat'],'statsRwater','-v7.3')