...
clear all;clc
%
base_path = 'Y:\Chenghang\04_4_Color\Control_Group\chenghaz_012_P8_Control_A\';
...
outpath = [base_path '\analysis\Result\'];
%
...
%
save([outpath 'add_to_statsGw10_edges_2.mat'],'centG_p140','tintsG_p140',...)
    'volumeG_p140','statxture_all','statxture_pos','-v7.3')
save([outpath 'statsG2w10_edges_plus_2.mat'],'statsGwater','-v7.3')