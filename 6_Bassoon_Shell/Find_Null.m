...
clear all;clc
%
% data_path = 'X:\Chenghang\Backup_Raw_Data\Shell_Analysis\data_p140_CTB\';
...
outpath = [exp_folder '\Result\7_null\'];
%
...
% save([outpath 'shell_p140.mat'],'area_p140','tints_p140');
% 
% temp = area_p140;
% 
...
list = [statsVwater.tints_p140];
s = statsVwater(find(list == 0));
