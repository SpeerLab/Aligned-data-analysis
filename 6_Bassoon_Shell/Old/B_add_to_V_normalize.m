...
clear all;clc
%
data_path = 'X:\Chenghang\Backup_Raw_Data\Shell_Analysis\data_p70_Normalized\';
pathname = strings(36,1);
pathname(1) = ['X:\Chenghang\Backup_Raw_Data\1.2.2021_P2EA_A\'];
pathname(2) = ['X:\Chenghang\Backup_Raw_Data\1.2.2021_P2EA_B\'];
pathname(3) = ['X:\Chenghang\Backup_Raw_Data\1.4.2021_P2EB_A\'];
pathname(4) = ['X:\Chenghang\Backup_Raw_Data\1.4.2021_P2EB_B\'];
pathname(5) = ['X:\Chenghang\4_Color\Raw\1.6.2021_P2EC_A\'];
pathname(6) = ['X:\Chenghang\4_Color\Raw\1.6.2021_P2EC_B\'];
pathname(7) = ['X:\Chenghang\Backup_Raw_Data\7.2.20.WT_P4EA\'];
pathname(8) = ['X:\Chenghang\Backup_Raw_Data\7.29.2020_P4EB\'];
pathname(9) = ['X:\Chenghang\Backup_Raw_Data\9.25.2020_P4EC_A\'];
pathname(10) = ['X:\Chenghang\Backup_Raw_Data\9.25.2020_P4EC_B\'];
pathname(11) = ['X:\Chenghang\Backup_Raw_Data\12.5.2020_P4ED_A\'];
pathname(12) = ['X:\Chenghang\Backup_Raw_Data\12.5.2020_P4ED_B\'];
pathname(13) = ['X:\Chenghang\Backup_Raw_Data\12.21.2020_P8EA_A\'];
pathname(14) = ['X:\Chenghang\Backup_Raw_Data\12.21.2020_P8EA_B\'];
...
pathname(19) = ['X:\Chenghang\Backup_Raw_Data\9.29.2020_B2P2A_A\'];
pathname(20) = ['X:\Chenghang\Backup_Raw_Data\9.29.2020_B2P2A_B\'];
pathname(21) = ['X:\Chenghang\4_Color\Raw\12.13.2020_B2P2B_A\'];
pathname(22) = ['X:\Chenghang\4_Color\Raw\12.13.2020_B2P2B_B\'];
pathname(23) = ['X:\Chenghang\Backup_Raw_Data\12.18.2020_B2P2C_A\'];
pathname(24) = ['X:\Chenghang\Backup_Raw_Data\12.18.2020_B2P2C_B\'];
pathname(25) = ['X:\Chenghang\Backup_Raw_Data\10.3.2020_B2P4A_A\'];
pathname(26) = ['X:\Chenghang\Backup_Raw_Data\10.3.2020_B2P4A_B\'];
pathname(27) = ['X:\Chenghang\Backup_Raw_Data\10.27.2020_B2P4B_A\'];
pathname(28) = ['X:\Chenghang\Backup_Raw_Data\10.27.2020_B2P4B_B\'];
pathname(29) = ['X:\Chenghang\Backup_Raw_Data\12.8.2020_B2P4C_A\'];
pathname(30) = ['X:\Chenghang\Backup_Raw_Data\12.8.2020_B2P4C_B\'];
pathname(31) = ['X:\Chenghang\Backup_Raw_Data\12.12.2020_B2P8A_A\'];
pathname(32) = ['X:\Chenghang\Backup_Raw_Data\12.12.2020_B2P8A_B\'];
...
%
%Original code match synapse to VGlut2. 
...
%parfor loop
clear Normalized_area Normalized_tints
...
%    statsVwater(jj).statxtureP_70pos = statxture([RPixelValues_m140(posvals2)]);
   ...
   Normalized_area(jj) = statsVwater(jj).volume_p140 / statsVwater(jj).area_p140;
   Normalized_tints(jj) = statsVwater(jj).tints_p140 / statsVwater(jj).area_p140;
...
area_p140_norm = [Normalized_area]';
tints_p140_norm = [Normalized_tints]';
save([outpath 'shell_p70_norm.mat'],'area_p140_norm','tints_p140_norm');

temp = area_p140_norm;

save([data_path 'Area_Norm_' sprintf('%03d',cur_path) '.txt'],'temp','-ascii','-double');

temp = tints_p140_norm;

save([data_path 'Tints_Norm_' sprintf('%03d',cur_path) '.txt'],'temp','-ascii','-double');
